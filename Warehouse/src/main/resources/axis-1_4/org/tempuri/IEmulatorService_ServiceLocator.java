...
public class IEmulatorService_ServiceLocator extends org.apache.axis.client.Service implements org.tempuri.IEmulatorService_Service {
    ...
    private java.lang.String BasicHttpBinding_IEmulatorService_address = "http://localhost:8081/Service.asmx";
    ...
    public org.tempuri.IEmulatorService_PortType getBasicHttpBinding_IEmulatorService() throws javax.xml.rpc.ServiceException {
    ...
    public org.tempuri.IEmulatorService_PortType getBasicHttpBinding_IEmulatorService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.tempuri.BasicHttpBinding_IEmulatorServiceStub _stub = new org.tempuri.BasicHttpBinding_IEmulatorServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.tempuri.IEmulatorService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                org.tempuri.BasicHttpBinding_IEmulatorServiceStub _stub = new org.tempuri.BasicHttpBinding_IEmulatorServiceStub(new java.net.URL(BasicHttpBinding_IEmulatorService_address), this);
                _stub.setPortName(getBasicHttpBinding_IEmulatorServiceWSDDServiceName());
                return _stub;
            }
        }
